...
<head>
    ...
    <link rel="stylesheet" href="docs/assets/css/fonts/linecons/css/linecons.css">
    <link rel="stylesheet" href="docs/assets/css/fonts/fontawesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="docs/assets/css/bootstrap.css">
    <link rel="stylesheet" href="docs/assets/css/xenon-core.css">
    <link rel="stylesheet" href="docs/assets/css/xenon-forms.css">
    <link rel="stylesheet" href="docs/assets/css/xenon-components.css">
    <link rel="stylesheet" href="docs/assets/css/xenon-skins.css">
    <link rel="stylesheet" href="docs/assets/css/custom.css">

    <script src="docs/assets/js/jquery-1.11.1.min.js"></script>
                ...
                <div class="user-info">
                    ...
                    <div class="user-image">
                        <a href="extra-profile.html">
                            <img src="docs/assets/images/user-2.png" class="img-responsive img-circle" />
                        </a>
                    </div>
            ...
            <header class="logo-env">
                ...
                <div class="logo">
                    <a href="dashboard-1.html" class="logo-expanded">
                        <img src="docs/assets/images/logo@2x.png" width="80" alt="" />
                    </a>

                    <a href="dashboard-1.html" class="logo-collapsed">
                        <img src="docs/assets/images/logo-collapsed@2x.png" width="40" alt="" />
                    </a>
                </div>
...
{{--                        <div class="user-info">--}}
{{--                            <a href="#">--}}
{{--                                <img src="docs/assets/images/user-1.png" width="30" height="30" alt="user-image" />--}}
{{--                            </a>--}}
{{--                        </div>--}}
...
{{--                        <div class="user-info">--}}
{{--                            <a href="#">--}}
{{--                                <img src="docs/assets/images/user-4.png" width="30" height="30" alt="user-image" />--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </li>--}}
...
<script src="docs/assets/js/TweenMax.min.js"></script>
<script src="docs/assets/js/resizeable.js"></script>
<script src="docs/assets/js/joinable.js"></script>
<script src="docs/assets/js/xenon-api.js"></script>
<script src="docs/assets/js/xenon-toggles.js"></script>


<!-- Imported scripts on this page -->
<script src="docs/assets/js/xenon-widgets.js"></script>
<script src="docs/assets/js/devexpress-web-14.1/js/globalize.min.js"></script>
<script src="docs/assets/js/devexpress-web-14.1/js/dx.chartjs.js"></script>
<script src="docs/assets/js/toastr/toastr.min.js"></script>


<!-- JavaScripts initializations and stuff -->
<script src="docs/assets/js/xenon-custom.js"></script>
