    ...
    <nav class="navbar user-info-navbar"  role="navigation"><!-- User Info, Notifications and Menu Bar -->
        ...
        <ul class="user-info-menu left-links list-inline list-unstyled">
            ...
            <li class="dropdown hover-line language-switcher">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="docs/assets/images/flags/flag-uk.png" alt="flag-uk" />
                    English
                </a>
                ...
                <ul class="dropdown-menu languages">
                    <li>
                        <a href="#">
                            <img src="docs/assets/images/flags/flag-al.png" alt="flag-al" />
                            Shqip
                        </a>
                    </li>
                    <li class="active">
                    ...
                    <li>
                        <a href="#">
                            <img src="docs/assets/images/flags/flag-de.png" alt="flag-de" />
                            Deutsch
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="docs/assets/images/flags/flag-fr.png" alt="flag-fr" />
                            Fran&ccedil;ais
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="docs/assets/images/flags/flag-br.png" alt="flag-br" />
                            Portugu&ecirc;s
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="docs/assets/images/flags/flag-es.png" alt="flag-es" />
                            Espa&ntilde;ol
                        </a>
                    </li>
                </ul>
        ...
        <ul class="user-info-menu right-links list-inline list-unstyled">
            ...
            <li class="dropdown user-profile">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="docs/assets/images/user-4.png" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
                    <span>
								John Smith
